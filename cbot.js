...
client.on("message", async message => {
    ...
    while(mTimes[message.channel] != [] && mTimes[message.channel][0]+10*1000 <Date.now()) {
        mTimes[message.channel]=mTimes[message.channel].slice(1);
        c[message.channel]=c[message.channel]-1
    }
